...
const NotFound = () => {
    ...
    return (
        <section className="h-screen w-full flex flex-col items-center justify-center p-6 bg-void text-center">
            ...
            <div className="absolute inset-0 flex items-center justify-center opacity-[0.03] select-none pointer-events-none uppercase overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
                ...
                <p className="max-w-md text-muted font-mono text-sm tracking-wide leading-relaxed mb-12">
                    Aradığınız tasarım felsefesi veya sayfa şu an bu ızgarada (grid) mevcut değil. Belki de henüz tasarlanmadı.
                </p>
            ...
            <div className="absolute bottom-8 left-8 font-mono text-[9px] text-white/10 tracking-widest uppercase">
                Error Code: 0x404 // Lost in Space
            </div>
            <div className="absolute bottom-8 right-8 font-mono text-[9px] text-white/10 tracking-widest uppercase">
