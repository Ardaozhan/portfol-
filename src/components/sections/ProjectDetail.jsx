...
const ProjectDetail = () => {
  ...
  const heroContentOpacity = useTransform(smoothProgress, [0, 0.15], [1, 0]);
  ...
  return (
    ...
    >
      {/* ── Global Effects ───────────────────────────────────────────── */}
      <motion.div
        className="fixed inset-0 z-[600] pointer-events-none opacity-20 contrast-[150%] brightness-75"
        style={{ background: spotlightFilter }}
      />
      ...
      <motion.div
        style={{ y: techY1 }}
        className="fixed top-20 right-20 z-0 pointer-events-none opacity-10"
      >
        <div className="font-mono text-[15vw] leading-none select-none">
          DATA_01
        </div>
      </motion.div>
      <motion.div
        style={{ y: techY2 }}
        className="fixed bottom-20 left-20 z-0 pointer-events-none opacity-10"
      >
        <div className="font-mono text-[15vw] leading-none select-none">
          CODE_0X
        </div>
      ...
      <div className="fixed top-0 left-0 w-full h-screen z-[500] pointer-events-none p-6 md:p-12 flex flex-col justify-between">
        <div className="flex justify-between items-start pointer-events-auto">
          ...
          >
            ...
            <span className="font-mono text-[10px] tracking-[0.4em] uppercase opacity-40 group-hover:opacity-100 transition-opacity">
              Exit_Archive
            </span>
          </button>
          <div className="text-right font-mono" aria-hidden="true">
        ...
        <div className="flex justify-between items-end pointer-events-auto">
          <div className="font-mono text-[10px] space-y-2" aria-hidden="true">
            <p className="opacity-20 uppercase tracking-[0.3em]">System_Log</p>
            <div className="flex flex-col gap-1">
              {[
                "Initialising...",
                "Decryption complete",
                "Accessing vault_00" + project.id,
              ].map((text, i) => (
                <motion.p
                  key={i}
                  initial={{ opacity: 0 }}
      ...
      <section className="sticky top-0 h-screen flex items-center justify-center overflow-hidden">
        <motion.div
          style={{ x: titleX, scale: titleScale }}
          className="relative z-10 select-none"
        >
          <h1
            className="text-[30vw] font-black leading-none uppercase tracking-tighter text-transparent"
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20">
          ...
          >
            <p className="font-mono text-lime text-xs tracking-[0.6em] uppercase mb-6">
      ...
      <section className="relative z-10 px-6 md:px-24 mb-[40vh]">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-24 items-end">
          <div className="md:col-span-7">
            ...
            >
              <span className="font-mono text-[10px] px-3 py-1 border border-lime text-lime uppercase tracking-widest inline-block">
                Analysis_01
              </span>
              <h3 className="text-4xl md:text-7xl font-black tracking-tighter uppercase leading-[0.85]">
                Identifying the{" "}
                <span className="text-lime">Core Constraint</span>
              </h3>
            ...
            >
              <div className="group relative overflow-hidden rounded-lg bg-surface/20">
                ...
                <div className="absolute bottom-0 left-0 w-full p-8 translate-y-full group-hover:translate-y-0 transition-transform duration-500 bg-gradient-to-t from-black to-transparent z-40">
                  <p className="font-mono text-[10px] text-lime mb-2 opacity-60">
                    Asset_Ref_{i}
                  </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {project.tags.map((t) => (
                  <span
                    key={t}
                    className="px-3 py-1 border border-white/10 text-white/40"
                  >
                    #{t.replace(" ", "_")}
                  </span>
                ))}
          ...
          <div className="md:col-span-8">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <span className="font-mono text-xs text-lime uppercase tracking-[0.5em] mb-12 block">
                // SYSTEM_VERIFICATION
              </span>
