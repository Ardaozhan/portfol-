        ...
        >
            ...
            <div className="relative flex items-center justify-between h-14 px-6 md:px-10">
                ...
                <div className="hidden md:flex items-center gap-7">
                    {SECTIONS.map((item) => (
                        <NavLink key={item.id} item={item} isActive={active === item.id} onClick={scrollTo} />
                    ))}
                </div>
            ...
            <motion.div
                ...
                style={{ borderBottom: menuOpen ? '1px solid rgba(255,255,255,0.05)' : 'none' }}
            >
                <div
                ...
                >
                    {SECTIONS.slice(1).map((item) => (
                        <a
                            ...
                            style={{ color: active === item.id ? 'var(--color-lime)' : 'var(--color-muted)', borderBottom: '1px solid rgba(255,255,255,0.04)' }}
